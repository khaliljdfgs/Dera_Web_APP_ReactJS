...
import { DVMInfoAddSchema, DVMInfoEditSchema } from './DVMInfoYupSchema'
import { FetchDVMData, SubmitDVMData } from './DVMInfoAxios'
import { InitialValues, StatusOptions, GenderOptions } from './DVMInfoValues'
...
const DVMInfo = () => {
  ...
  useEffect(() => {
    document.title = `DVM Info | ${APP_TITLE}`
