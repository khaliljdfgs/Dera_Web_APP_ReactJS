...
import { FetchConsumers, DeleteConsumer } from './ConsumersAxios'
...
const Consumers = () => {
  ...
  useEffect(() => {
    document.title = `Consumers | ${APP_TITLE}`
                ...
                <Container className='m-0 p-0'>
                  <Row className='m-0 p-0'>
                    <Col className='m-0 p-0'>
                      <Button
                        variant='primary'
                        onClick={() => navigate('/Admin/ConsumerInfo')}
              ...
              renderRowActions={({ row, table }) => (
                <Box sx={{ display: 'flex' }}>
                  <Tooltip
                    ...
                    placement='left'
                    title='Edit'>
                    <IconButton onClick={() => navigate(`/Admin/ConsumerInfo/${row.original.uid}`)}>
                      <Edit />
                    </IconButton>
                  </Tooltip>
                  <Tooltip
                    ...
                    <IconButton
                      color='primary'
                      onClick={() => {
                        navigate(`/Admin/ConsumerInfo/${row.original.uid}`, {
                          state: {
                            mode: 0,
                          },
                        })
...

        {
          showDeleteDialogue.status
            ...
            <CustomAlertDialogue
              ...
              <ul>
                <li>Consumer User's Account</li>
                <li>Consumer User's Notifications</li>
                <li>Dairy Products Subscriptions</li>
                <li>Dairy Products Orders and History</li>
                <li>Chats Between DERAs and Consumer User</li>
              </ul>
            </CustomAlertDialogue>
            : ''
        }
