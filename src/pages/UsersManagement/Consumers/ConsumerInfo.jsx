...
import { ConsumerInfoAddSchema, ConsumerInfoEditSchema } from './ConsumerInfoYupSchema'
import { FetchConsumerData, SubmitConsumerData } from './ConsumerInfoAxios'
import { InitialValues, StatusOptions, GenderOptions } from './ConsumerInfoValues'
...
const ConsumerInfo = () => {
  ...
  const ConsumerSchema = isEditMode
    ? ConsumerInfoEditSchema
    : ConsumerInfoAddSchema

  const [initialValues, setInitialValues] = useState({ ...InitialValues })

  useEffect(() => {
    document.title = `Consumer Info | ${APP_TITLE}`
      ...
      <Formik
        ...
        {(formik) => (
          <Form onSubmit={formik.handleSubmit} className='m-0 p-0' method='POST'>
            ...
            <GoBackButton path='/Admin/Consumers' />
          </Form>
        )}
      </Formik>
    </Container>
