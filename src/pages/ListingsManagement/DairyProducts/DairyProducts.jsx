...
import { FetchDairyProducts, DeleteDairyProduct } from './DairyProductsAxios'
...
const DairyProducts = () => {
  ...
  const columns = useMemo(() => [
    ...
    { accessorKey: 'productName', header: 'Title', size: 0 },
              ...
              renderRowActions={({ row, table }) => (
                <Box sx={{ display: 'flex' }}>
                  <Tooltip
                    ...
                    placement='left'
                    title='Edit'>
                    <IconButton onClick={() => navigate(`/Admin/DairyProductInfo/${row.original.uid}`)}>
                      <Edit />
                    </IconButton>
                  </Tooltip>
                  <Tooltip
                    ...
                    <IconButton
                      color='primary'
                      onClick={() => {
                        navigate(`/Admin/DairyProductInfo/${row.original.uid}`, {
                          state: {
                            mode: 0,
                          },
                        })
...

        {
          showDeleteDialogue.status
            ...
            <CustomAlertDialogue
              ...
              <p>Are you sure you want to delete this dairy product?</p>
              <p>Once deleted, you will not be able to revert the changes! Following information will be deleted:</p>
              <ul>
                <li>Dairy Product's Information</li>
                <li>Dairy Product's Orders and History</li>
              </ul>
            </CustomAlertDialogue>
            : ''
        }
